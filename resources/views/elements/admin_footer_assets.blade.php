    ...
    <script src="{{ asset('admin/app-assets/js/fancybox.min.js') }}"></script>
    ...
    <script src="{{ asset('admin/app-assets/js/global.js') }}"></script>

    <script type="text/javascript" src="{{ asset('admin/app-assets/plugin/ckeditor/ckeditor.js') }}"></script>
