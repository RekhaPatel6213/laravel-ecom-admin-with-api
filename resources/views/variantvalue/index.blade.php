    ...
    @section('content')
        <div class="content-wrapper p-0">
            ...
            @include('elements.breadcrumb', ['route' => null, 'parentName' => null, 'name' => __('Variant Value'), 'isAction' => true, 'newRoute' => route('variantvalue.create'), 'newName' => __('Add'), 'isDelete' => true])
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-datatable">
                                    <table class="dt-column-search table table-responsive table-bordered" id="variantValue">
                                        <thead>
                                            <tr>
        ...
        <script>
            var table_id = $("#variantValue");
            var delete_url="{{ route('variantvalue.multiple_delete') }}";
            var status_url="{{ route('variantvalue.change_status') }}";
