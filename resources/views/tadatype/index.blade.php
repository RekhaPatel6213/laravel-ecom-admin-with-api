@extends('layouts.admin')
    @section('content')
        <div class="content-wrapper p-0">
            ...
            @include('elements.breadcrumb', ['route' => null, 'parentName' => null, 'name' => __('TA/DA Type'), 'isAction' => true, 'newRoute' => route('tadatype.create'), 'newName' => __('Add'), 'isDelete' => true, 'isImport' => false])
        ...
        <script>
            ...
            var status_url="{{ route('tadatype.change_status') }}";
