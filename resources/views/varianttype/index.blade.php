@extends('layouts.admin')
    @section('content')
        <div class="content-wrapper p-0">
            ...
            @include('elements.breadcrumb', ['route' => null, 'parentName' => null, 'name' => __('Variant Type'), 'isAction' => true, 'newRoute' => route('varianttype.create'), 'newName' => __('Add'), 'isDelete' => true])
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-datatable">
                                    <table class="dt-column-search table table-responsive table-bordered" id="variantType">
                                        <thead>
                                            <tr>
        ...
        <script>
            var table_id = $("#variantType");
            var delete_url="{{ route('varianttype.multiple_delete') }}";
            var status_url="{{ route('varianttype.change_status') }}";
