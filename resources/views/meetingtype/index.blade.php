@extends('layouts.admin')
    @section('content')
        <div class="content-wrapper p-0">
            ...
            @include('elements.breadcrumb', ['route' => null, 'parentName' => null, 'name' => __('Meeting Type'), 'isAction' => true, 'newRoute' => route('meetingtype.create'), 'newName' => __('Add'), 'isDelete' => true])
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-datatable">
                                    <table class="dt-column-search table table-responsive table-bordered" id="meetingType">
                                        <thead>
                                            <tr>
        ...
        <script>
            var table_id = $("#meetingType");
            var delete_url="{{ route('meetingtype.multiple_delete') }}";
            var status_url="{{ route('meetingtype.change_status') }}";
