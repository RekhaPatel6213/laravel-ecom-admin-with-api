...
@section('content')
    <div class="content-wrapper p-0">
        ...
        @include('elements.breadcrumb', ['route' => null, 'parentName' => null, 'name' => __('Company Sales Person'), 'isAction' => true, 'newRoute' => route('user.create'), 'newName' => __('Add'), 'isDelete' => true, 'isImport' => false])
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-datatable">
                                <table class="dt-column-search table table-responsive table-bordered" id="User">
                                    <thead>
                                        <tr>
            ...
            if (dt_filter_table.length) {
                ...
                var dt_filter = dt_filter_table.DataTable({
                    ...
                    columns: [
                        ...
                        { data: 'daily_allowance', orderable: true },
                        { data: 'distributors', orderable: true },
                    ...
                    buttons: [
                        ...
                        },
                        {
                            ...
                            filename: 'Company_Sales_Person_List_' + new Date().toISOString().slice(0, 10),
                            exportOptions: {
