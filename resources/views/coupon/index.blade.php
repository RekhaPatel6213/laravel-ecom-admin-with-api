    ...
    @section('content')
        <div class="content-wrapper p-0">
            ...
            @include('elements.breadcrumb', ['route' => null, 'parentName' => null, 'name' => __('Coupon'), 'isAction' => true, 'newRoute' => route('coupon.create'), 'newName' => __('Add'), 'isDelete' => true])
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-datatable">
                                    <table class="dt-column-search table table-responsive table-bordered" id="Counpon">
                                        <thead>
                                            <tr>
        ...
        <script>
            var table_id = $("#Counpon");
            var delete_url="{{ route('coupon.multiple_delete') }}";
            var status_url="{{ route('coupon.change_status') }}";
