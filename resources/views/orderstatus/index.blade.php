    ...
    @section('content')
        <div class="content-wrapper p-0">
            ...
            @include('elements.breadcrumb', ['route' => null, 'parentName' => null, 'name' => __('Order Status'), 'isAction' => true, 'newRoute' => route('orderstatus.create'), 'newName' => __('Add'), 'isDelete' => true, 'isImport' => false])
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-datatable">
                                    <table class="dt-column-search table table-responsive table-bordered" id="OrderStatus">
                                        <thead>
                                            <tr>
        ...
        <script>
            var table_id = $("#OrderStatus");
            var delete_url="{{ route('orderstatus.multiple_delete') }}";
            var status_url="{{ route('orderstatus.change_status') }}";
                ...
                if (dt_filter_table.length) {
                    ...
                    var dt_filter = dt_filter_table.DataTable({
                        ...
                        columns: [
                            ...
                            { data: 'order_status_name',orderable:true },
