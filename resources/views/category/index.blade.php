    ...
    @section('content')
        <div class="content-wrapper p-0">
            ...
            @include('elements.breadcrumb', ['route' => null, 'parentName' => null, 'name' => __('Category'), 'isAction' => true, 'newRoute' => route('category.create'), 'newName' => __('Add'), 'isDelete' => true, 'isImport' => false])
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-datatable">
                                    <table class="dt-column-search table table-responsive table-bordered" id="Category">
                                        <thead>
                                            <tr>
                ...
                if (dt_filter_table.length) {
                    ...
                    var dt_filter = dt_filter_table.DataTable({
                        ...
                        columns: [
                            ...
                            { data: 'parent_category',orderable:true },
