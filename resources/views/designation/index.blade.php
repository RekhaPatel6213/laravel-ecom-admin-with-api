@extends('layouts.admin')
    @section('content')
        <div class="content-wrapper p-0">
            ...
            @include('elements.breadcrumb', ['route' => null, 'parentName' => null, 'name' => __('Designation'), 'isAction' => true, 'newRoute' => route('designation.create'), 'newName' => __('Add'), 'isDelete' => true])
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-datatable">
                                    <table class="dt-column-search table table-responsive table-bordered" id="designation">
                                        <thead>
                                            <tr>
