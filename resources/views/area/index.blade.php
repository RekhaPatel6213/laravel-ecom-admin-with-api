@extends('layouts.admin')
    @section('content')
        <div class="content-wrapper p-0">
            ...
            @include('elements.breadcrumb', ['route' => null, 'parentName' => null, 'name' => __('Route'), 'isAction' => true, 'newRoute' => route('area.create'), 'newName' => __('Add'), 'isDelete' => true])
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-datatable">
                                    <table class="dt-column-search table table-responsive table-bordered" id="Area">
                                        <thead>
                                            <tr>
        ...
        <script>
            var table_id = $("#Area");
            var delete_url="{{ route('area.multiple_delete') }}";
            var status_url="{{ route('area.change_status') }}";
