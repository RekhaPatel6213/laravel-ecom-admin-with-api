    ...
    @section('content')
        <div class="content-wrapper p-0">
            ...
            @include('elements.breadcrumb', ['route' => null, 'parentName' => null, 'name' => __('City'), 'isAction' => true, 'newRoute' => route('city.create'), 'newName' => __('Add'), 'isDelete' => true])
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-datatable">
                                    <table class="dt-column-search table table-responsive table-bordered" id="City">
                                        <thead>
                                            <tr>
                ...
                if (dt_filter_table.length) {
                    ...
                    var dt_filter = dt_filter_table.DataTable({
                        ...
                        columnDefs: [
                            ...
                            {"targets": [1,5,6,7], "className": "text-center"}
                        ],
                        "order": [[1, 'desc']],
