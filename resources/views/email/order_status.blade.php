            ...
            <main>
                <div style="margin: 0; margin-top: 20px; padding: 30px; background: #ffffff; border-radius: 30px; text-align: left;">
                    <div style="width: 100%; max-width: 489px; margin: 0 auto;">
                        ...
                        <h1 style="margin: 0; font-size: 20px; font-weight: 500; color: #1f1f1f;">Your Order status updated to {{$orderData['orderstatus']['order_status_name']}} for order <strong style="color: #e31e2a;">#{{$orderData->order_no}}</strong>
                        </h1>
                        <p style="margin: 0; margin-top: 17px; font-weight: 500; letter-spacing: 0.56px;"><strong>Order ID:</strong> #{{$orderData->order_no}}</p>
                        <p style="margin: 0; margin-top: 17px; font-weight: 500; letter-spacing: 0.56px;"><strong>Order Status:</strong> {{$orderData['orderstatus']['order_status_name']}}</p>
                        <p style="margin: 0; margin-top: 17px; font-weight: 500; letter-spacing: 0.56px;"><strong>Order Comments:</strong> {{$comment}}</p>
                    </div>
                </div>
            </main>
        </div>
