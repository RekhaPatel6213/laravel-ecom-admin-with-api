...
class DesignationController extends Controller
{
    ...
    {
        $this->service = app('designation.service');
    }
    ...
    public function create()
    {
        try {
            ...
            return view('designation.create', compact('sortId'));
        } catch (Exception $exception) {
    ...
    public function store(DesignationRequest $request)
    {
        try {
            ...
            return redirect()->route('designation.index')->with('success_message', __('message.submitSuccess'));
        } catch (Exception $exception) {
            return back()->with('error_message', $exception->getMessage());
        }
    }
    ...
    {
        try {
            $this->service->update($request->all(), $designation);
